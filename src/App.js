  ...
  return (
    ...
    {/* routes */}
      ...
      <Routes>
        ...
        <Route path="/login/registrationform" element={<Rform/>}/>
        <Route path="/register/registrationform" element={<Rform/>}/>
        <Route path="/register/registrationform/udidupload" element={<UDID/>}/>
        <Route path="/register/registrationform/udidupload/aadharcardupload" element={<AadharCard/>}/>
        <Route path="/register/registrationform/udidupload/aadharcardupload/incomecftupload"element={<IncomeCft/>}/>
